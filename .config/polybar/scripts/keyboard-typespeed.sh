...
# wpm: average 30, pro 50-80, advanced 120+, 216 world record
# TODO prevent script from jumping down to zero, need to averaege and only truncate every minute
...
while true; do
	...
	# Truncate the cache file so that in the next iteration, we only count new keypresses
	printf '' > "$hackspeed_cache"
