...
-- cursorcolumn is a window option, not a buffer option
-- E5113: Error while calling lua chunk: /home/nicholas/.config/nvim/lua/mapping.lua:3: module 'nvim-autopairs' not found:
--         no field package.preload['nvim-autopairs']
--         no file './nvim-autopairs.lua'
--         no file '/home/nicholas/.local/src/neovim/.deps/usr/share/luajit-2.1.0-beta3/nvim-autopairs.lua'
--         no file '/usr/local/share/lua/5.1/nvim-autopairs.lua'
--         no file '/usr/local/share/lua/5.1/nvim-autopairs/init.lua'
--         no file '/home/nicholas/.local/src/neovim/.deps/usr/share/lua/5.1/nvim-autopairs.lua'
--         no file '/home/nicholas/.local/src/neovim/.deps/usr/share/lua/5.1/nvim-autopairs/init.lua'
--         no file './nvim-autopairs.so'
--         no file '/usr/local/lib/lua/5.1/nvim-autopairs.so'
--         no file '/home/nicholas/.local/src/neovim/.deps/usr/lib/lua/5.1/nvim-autopairs.so'
--         no file '/usr/local/lib/lua/5.1/loadall.so'
-- Error detected while processing /home/nicholas/resources/config/.config/nvim/after/plugin/dashboard.vim:
-- line    8:
-- E121: Undefined variable: g:dashboard_version
-- E15: Invalid expression: [ '                                 ,', '                              ,   ,`|', '                            ,/|.-`   \.', '                         .-`  `       |.', '                   ,  .-`              |', '
--                 /|,`                 |`', '                 / `                    |  ,', '                /                       ,`/', '             .  |          _              /', '              \`` .-.    ,` `.           |', '
--       \ /   \ /      \          /', '                \|    V        |        |  ,', '                 (           ) /.--.   ``"/', '                 "b.`. ,` _.ee`` 6)|   ,-`', '                   \"= --""  )   ` /.-`', '
--  \ / `---"   ."|`', '                     \"..-    .`  |.', '                      `-__..-`,`   |', '                   __.) ` .-`/    /\._', '              _.--`/----..--------. _.-""-._', '           .-`_)   \.   /     __..-`     _.-`--.'
-- , '          / -`/      """""""""         ,`-.   . `.', '
-- Error detected while processing /home/nicholas/resources/config/.config/nvim/lazy/vim-endwise.vim:
-- line   53:
-- E216: No such group or event: endwise CmdwinEnter * call s:teardownMappings()
-- Error detected while processing BufEnter Autocommands for "*":
-- E5108: Error executing lua [string "v:lua"]:1: attempt to index global 'WhichKey' (a nil value)
-- E5108: Error executing lua /home/nicholas/.config/nvim/lua/myplugins/vcs/git/init.lua:200: attempt to index global 'key_maps' (a nil value)
-- Error detected while processing CursorHold Autocommands for "*":
-- E5108: Error executing lua [string ":lua"]:1: module 'nvim-lightbulb' not found:
--         no field package.preload['nvim-lightbulb']
--         no file './nvim-lightbulb.lua'
--         no file '/home/nicholas/.local/src/neovim/.deps/usr/share/luajit-2.1.0-beta3/nvim-lightbulb.lua'
--         no file '/usr/local/share/lua/5.1/nvim-lightbulb.lua'
--         no file '/usr/local/share/lua/5.1/nvim-lightbulb/init.lua'
--         no file '/home/nicholas/.local/src/neovim/.deps/usr/share/lua/5.1/nvim-lightbulb.lua'
--         no file '/home/nicholas/.local/src/neovim/.deps/usr/share/lua/5.1/nvim-lightbulb/init.lua'
--         no file './nvim-lightbulb.so'
--         no file '/usr/local/lib/lua/5.1/nvim-lightbulb.so'
--         no file '/home/nicholas/.local/src/neovim/.deps/usr/lib/lua/5.1/nvim-lightbulb.so'
--         no file '/usr/local/lib/lua/5.1/loadall.so'
-- Error detected while processing CursorHold Autocommands for "*":
-- E5108: Error executing lua [string ":lua"]:1: module 'nvim-lightbulb' not found:
--         no field package.preload['nvim-lightbulb']
