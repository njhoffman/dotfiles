...
local highlight_groups = {
    ...
    Comment = {fg = "#6a717e", style = 'italic'}, -- any comment
    -- Constant = {fg = green0}, -- any constant
    Constant = {fg = '#87afff'}, -- any constant
    -- String = {fg = aqua0, style = 'italic'}, -- this is a string
    String = {fg = '#22BB99'}, -- this is a string
    ...
    Identifier = {fg = '#b6b6de'}, -- any variable name
    -- Function = {fg = purple0, style = 'bold'}, -- function name (also: methods for classes)
    Function = {fg = '#e2bd8c'}, -- function name (also: methods for classes)
    -- Statement = {fg = blue0}, -- any statement
    Statement = {fg = '#8197bc'}, -- any statement
    ...
    Keyword = {fg = '#9eadf6', style = 'bold'}, -- any other keyword
    Exception = {fg = red}, -- try, catch, throw
    -- PreProc = {fg = purple1}, -- generic Preprocessor
    PreProc = {fg = '#8fbfdc'}, -- generic Preprocessor
    ...
    Type = {fg = '#becde6'}, -- int, long, char, etc.
    ...
    Delimiter = {fg = '#7F90AA'}, -- character that needs attention
    ...
    Underlined = {fg = blue0, style = 'bold'}, -- text that stands out, HTML links
    ...
    CursorLineNr = {fg = '#afd7ff'}, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
...
require('space-nvim')(highlight_group_normal, highlight_groups, terminal_ansi_colors)
