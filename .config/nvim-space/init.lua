...
opt("o", "scrolloff", 10) -- Keep at least 10 lines above/below
opt("o", "sidescrolloff", 10) -- Keep at least 10 lines left/right
opt("w", "number", true) -- Print line number
opt("w", "relativenumber", false) -- Show line number relative to current line
...
opt("o", "cmdheight", 1) -- Height of the command line
