...
vim.g.fzf_preview_command =
    "COLORTERM=truecolor bat --color=always --plain {-1}"

vim.g.fzf_preview_fzf_preview_window_option = "down:50%"

vim.g.fzf_preview_dev_icons_limit = 20000

vim.g.fzf_preview_grep_cmd =
    "COLORTERM=truecolor rg --line-number --no-heading --hidden"
...
vim.cmd([[let $FZF_PREVIEW_PREVIEW_BAT_THEME = "base16"]])
