local nord = require("nord-nick.colors")
...
theme.loadSyntax = function()
  ...
  local syntax = {
    ...
    Error = {fg = nord.error, bg = nord.none, style = "bold"}, -- any erroneous construct
    ...
    htmlLink = {fg = nord.link, style = "italic"},
  ...
  syntax.Comment = {fg = nord.nord3_gui_bright, style = "italic"}
...
theme.loadEditor = function()
  ...
  local editor = {
    ...
    Search = {bg = "NONE", fg = "#44aaff"},
    -- Search = {fg = "#1babc6", bg = "NONE", gui = "standout"},
    ...
    IncSearch = {fg = "#00DDFF", bg = "#333355"},
    HlSearchLensCur = {guifg = "#ff2266", guibg = "#003333"},
    HlSearchLens = {guifg = "#00DDFF", guibg = "none"},
    HlSearchCur = {guifg = "#00FFDD", guibg = "none"},
...
theme.loadTreeSitter = function()
  ...
  treesitter.TSVariable = {fg = nord.accent}
...
theme.loadPlugins = function()
  ...
  local plugins = {
    ...
    GitSignsChangeDelete = {fg = nord.purple}, -- diff mode: Delete Changed line |diff.txt|
    GitSignsChangeDeleteNr = {fg = nord.purple}, -- diff mode: Delete Changed line |diff.txt|
    GitSignsChangeDeleteLn = {fg = nord.purple}, -- diff mode: Delete Changed line |diff.txt|
    ...
    -- GitSigns Faded
    GitSignsAddFaded = {fg = nord.green_faded},
    GitSignsAddNrFaded = {fg = nord.green_faded},
    GitSignsAddLnFaded = {fg = nord.green_faded},
    GitSignsChangeFaded = {fg = nord.yellow_faded},
    GitSignsChangeNrFaded = {fg = nord.yellow_faded},
    GitSignsChangeLnFaded = {fg = nord.yellow_faded},
    GitSignsChangeDeleteFaded = {fg = nord.purple_faded},
    GitSignsChangeDeleteNrFaded = {fg = nord.purple_faded},
    GitSignsChangeDeleteLnFaded = {fg = nord.purple_faded},
    GitSignsDeleteFaded = {fg = nord.red_faded},
    GitSignsDeleteNrFaded = {fg = nord.red_faded},
    GitSignsDeleteLnFaded = {fg = nord.red_faded},
    -- Telescope
    ...
    Sneak = {fg = nord.paleblue, bg = nord.bg_alt},
