...
local rings_settings={
	...
	border_size=1,
	background=false,
	fg_colour1={{0,0x00FF00,0.3}},
	fg_colour2={{0,0xFF0000,0.5}},
	bd_colour1={{1,0x00ff99,0.3}},
	},
	{
	name="fs_used_perc",
	arg="/mnt/E_Download",
...
--main function
	...
	if tonumber(conky_parse('${updates}'))>3 then
		for i in pairs(rings_settings) do
			draw_sector_ring(cr,rings_settings[i])
		end
	end
...
function draw_sector_ring(cr, t)
